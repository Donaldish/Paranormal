...
function Library:CreateMain()
	...
	---@param imgid number Image of the notification. Set to nil if you don't want to use it.
	function NotificationLibrary:Notify(title, desc, time, imgid)
		if imgid == nil then imgid = 274183392 end
		game.StarterGui:SetCore("SendNotification", {
			Title = title;
			Text = desc;
			Icon = ("rbxassetid://".. imgid);
			Duration = time;
		})
	end
	...
	---@param desc string Description of the notification
	---@param time number How long the notification lasts
	---@param imgid number Image of the notification. Set to nil if you do not want to use it.
	...
	function NotificationLibrary:NotifyOptions(title, desc, time, imgid, option1, option2, callback)
